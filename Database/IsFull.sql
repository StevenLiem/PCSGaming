...
--uji coba pakai member
insert into TOKEN_CONTENTS(TOKEN_ID, CONTENT_ID, MEMBER_ID, QTY) values('COBATOKEN1', 'YK001', 'MW001', 1);
insert into TOKEN_CONTENTS(TOKEN_ID, CONTENT_ID, MEMBER_ID, QTY) values('COBATOKEN1', 'YK002', 'MW001', 2);
--uji coba tidak pakai member
insert into TOKEN_CONTENTS(TOKEN_ID, CONTENT_ID, MEMBER_ID, QTY) values('COBATOKEN2', 'YK001', NULL, 1);
insert into TOKEN_CONTENTS(TOKEN_ID, CONTENT_ID, MEMBER_ID, QTY) values('COBATOKEN2', 'YK002', NULL, 1);
insert into TOKEN_CONTENTS(TOKEN_ID, CONTENT_ID, MEMBER_ID, QTY) values('COBATOKEN2', 'RE001', NULL, 1);

insert into TRANSACTION(TOKEN, MEMBER_ID, TRANSACTION_DATE, TOTAL) values('COBATOKEN1', 'MW001', TO_DATE('05/05/2021', 'DD/MM/YYYY'), 260000);

insert into TRANSACTION(TOKEN, MEMBER_ID, TRANSACTION_DATE, TOTAL) values('COBATRANS1', 'MW001', TO_DATE('05/05/2021', 'DD/MM/YYYY'), 260000);
insert into TRANSACTION(TOKEN, MEMBER_ID, TRANSACTION_DATE, TOTAL) values('COBATRANS2', NULL, TO_DATE('05/05/2021', 'DD/MM/YYYY'), 260000);
insert into TRANSACTION(TOKEN, MEMBER_ID, TRANSACTION_DATE, TOTAL) values('COBATRANS3', NULL, TO_DATE('05/05/2021', 'DD/MM/YYYY'), 260000);

insert into GAME_TRANSACTION(GAME_ID, TOKEN, PRICE, QTY, SUBTOTAL) values
